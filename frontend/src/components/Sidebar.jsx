import { Sparkles, Plus, FileText, Trash2, Settings, Loader2 } from 'lucide-react';
import { formatRelativeTime } from '../utils/helpers';

export default function Sidebar({ documents, isDeleting, onDelete, onNewChat, selectedDocuments, setSelectedDocuments, sessions = [], currentSessionId, onSelectSession, onDeleteSession }) {
  ...
  return (
    <div className="w-64 flex-shrink-0 bg-card border-r border-border flex flex-col h-full">
      {/* App Logo */}
      ...
      <div className="p-4 border-t border-border mt-auto">
        <button className="flex items-center gap-2 text-sm text-zinc-400 hover:text-zinc-200 transition-colors w-full p-2 hover:bg-zinc-900 rounded-lg">
